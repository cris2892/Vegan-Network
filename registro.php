            ...
            <div class="  p-3 col-12 col-sm-12 col-md-8 col-lg-4 align-center">
              <form class="" action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="inputEmail" aria-describedby="emailHelp" placeholder="Ingrese su email">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="passwordRepeat"class="form-control" id="inputPasswordRepeat" placeholder="Repita la Contraseña">
                </div>
